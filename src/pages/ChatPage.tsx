...
export default function ChatPage() {
  ...
  return (
    <div className="relative flex h-full w-full overflow-hidden bg-[#f1f5f9]">
      {/* Blue header band */}
      <div className="pointer-events-none absolute inset-x-0 top-0 z-0 h-[127px] bg-gradient-to-r from-blue-600 to-blue-500" />

      <div className="relative z-10 mx-auto flex h-full w-full max-w-[1800px] justify-center">
        <div
          className={`flex w-full flex-col md:w-[420px] md:shrink-0 md:border-r md:border-[#d8dee9] ${
